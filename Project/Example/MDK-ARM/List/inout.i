...
if(flag_out==1)	
{	
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH=0x338883B3;	
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x01000000);				
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL=0x33333333;						
        flag=0;
				for(qqq1=0;qqq1<=50;qqq1++)
					{						

					if((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR)&((uint16_t)0x1000))	
							{
								flag=1;
								break;
							}	
				...
				if (flag==0)	
				{
					...
					((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x04000000);	
          ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00000100);				
					((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH=0x338888B3;	
					return;
				}						
	for	(number_send_byte=0;number_send_byte<=101;number_send_byte++)
		{					
				((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->ODR=izmer[number_send_byte];	
				((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00000400);
				if(((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR)&0x1000)==0x0000)	{break;}			
				((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x04000000);		
		}			
	flag=0;
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL=0x88888888;	
...
{
if((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR)&((uint16_t)0x0800))
	{
		flag=1;
		break;
	}
...
if(flag==0)
{
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x10000000);
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH=0x338888B3;	
return;		
}	
if(((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR)&((uint16_t)0x0800))==0)
{
		  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH=0x338388B3;	
			((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00001000); 
}	
	    while(((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR)&((uint16_t)0x0800))==0)
			{
			  if(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR&((uint16_t)0x0400)) input_byte=((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->IDR; 
        else
					if(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR&((uint16_t)0x0400)) input_byte=((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->IDR; 
          else
					if(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR&((uint16_t)0x0400)) input_byte=((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->IDR; 
				...
				if(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR&((uint16_t)0x0400)) 
									if(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR&((uint16_t)0x0400)) 
														if(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR&((uint16_t)0x0400)) 
																			if(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR&((uint16_t)0x0400)) 
					if(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR&((uint16_t)0x0400))
						if(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR&((uint16_t)0x0400)) break;	
