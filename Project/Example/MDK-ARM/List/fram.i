...
void	Write_to_FRAM (uint32_t AddrFRAM, uint16_t DataFRAM)
{
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRH=0x33333333;	
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->ODR=AddrFRAM;
				Delay_mks(1);
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00200000);	
				Delay_mks(1);
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00000020);
AddrFRAM=AddrFRAM >> 16;			
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->ODR=AddrFRAM;
				Delay_mks(1);
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x80000000);	
				Delay_mks(1);
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00008000);

	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->ODR=DataFRAM;	
				Delay_mks(1);
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00040000);	
				Delay_mks(1);
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00400000);	
				Delay_mks(1);
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00000040);	
			Delay_mks(1);
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00000004);	
...
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00040000);	
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00800000);	
				Delay_mks(1);
	read=((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->IDR;
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00000080);	
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00000004);	
