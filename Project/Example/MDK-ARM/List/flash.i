...
void WriteFLASH(u16 *Source, u32 BegAddr, u16 SizeFLASH)
{
  ...
  ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->KEYR=((u32)0x45670123);		
  ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->KEYR=((u32)0xCDEF89AB);		
	
  while(((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->SR & ((uint8_t)0x01));		
  
	((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR|=((uint16_t)0x0002);
  ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->AR=BegAddr;
  ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR|=((uint16_t)0x0040);	
  while(((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->SR & ((uint8_t)0x01));		
	
	((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR&=(~((uint16_t)0x0002));
	
 	((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR|=((uint16_t)0x0001);
		
		
		while (NumFLASH && ((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->SR & ((uint8_t)0x01))==0))
    {
    	...
    	*(vu16*)BegAddrFLASH=*BufFLASH++;
			...
			{
				((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR&=(~((uint16_t)0x0001));
				((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR|=((uint16_t)0x0080);
			}
		}	
	}			
