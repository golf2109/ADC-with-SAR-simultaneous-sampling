...
void	FRAM_init	(void)
{
	Write_to_FRAM(0x0000,0xAA55);
	Write_to_FRAM(0x0001,0x11);
	Write_to_FRAM(0x0002,0x31);

	Write_to_FRAM(0x0010,0x01);
	Write_to_FRAM(0x0011,0x31);
	Write_to_FRAM(0x0012,0x12);
	Write_to_FRAM(0x0013,0x14);
	Write_to_FRAM(0x0014,0x23);
	Write_to_FRAM(0x0015,0x59);
	Write_to_FRAM(0x0016,0x59);
	Write_to_FRAM(0x0017,0x39);
	Write_to_FRAM(0x0018,0x39);
	Write_to_FRAM(0x0019,0xAA);
	Write_to_FRAM(0x001A,0xBB);
	Write_to_FRAM(0x001B,0xCC);
...
{
	N_ocill=1;   
	begin_oscill=0x00000100;      
	length_oscill=0x00001000;   
}
