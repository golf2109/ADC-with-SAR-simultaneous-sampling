...
void RCC_Configuration(void)
{
  __asm {
	...
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR|=((uint32_t)0x00000300);
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR|=((uint32_t)0x00008000);
  
	((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->ACR=((uint8_t)0x10)|((uint8_t)0x02);
	
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR=((uint32_t)0x001C0000)|((uint32_t)0x00010000)|((uint32_t)0x00000400);
  
	while ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR&((uint32_t)0x00020000))==0);
	...
	while ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR&((uint32_t)0x0000000C))!=((uint32_t)0x00000008));
	

	

((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR=((uint32_t)0x00000010)|((uint32_t)0x00000008)|((uint32_t)0x00000004)|((uint32_t)0x00000001);
	

	
	((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR=((uint16_t)0x0060)|((uint16_t)0x0010);
}
void my_RCC_Configuration(void)
{
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR |= ((uint32_t)0x00000004) | ((uint32_t)0x00000008) | ((uint32_t)0x00000010); 
}
...
void GPIO_Configuration(void)
{
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRL=0x33333333;
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH=0x33888833;	
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR=0x000001FF;	
	
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL=0x88888888;
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRH=0x88888888;
	



((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->MAPR  = 0x02000000;

((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EVCR =0xAD; 
((BKP_TypeDef *) (((uint32_t)0x40000000) + 0x6C00))->RTCCR |=	((uint16_t)0x0080); 
...
void UART_Configuration(void)
{
    ...
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH = 0x000004B0;

	
	
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR|= ((uint32_t)0x00004000) | ((uint32_t)0x00000004) | ((uint32_t)0x00000001);
  
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH  |= ((uint32_t)0x00000080) | ((uint32_t)0x00000010) | ((uint32_t)0x00000400);
  
  ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->BRR  = 72000000/921600;                
	
  
  ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->CR1 |= ((uint16_t)0x0008) | ((uint16_t)0x0004);
  
  ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->CR1 |= ((uint16_t)0x2000);
...
void IWDG_Configuration(void)
{
	...
	((IWDG_TypeDef *) (((uint32_t)0x40000000) + 0x3000))->PR=0;						
	((IWDG_TypeDef *) (((uint32_t)0x40000000) + 0x3000))->KR=0x5555;
	((IWDG_TypeDef *) (((uint32_t)0x40000000) + 0x3000))->RLR=1000;				
...
void	DMA_Configuration(void)
{
  ...
  DMA_DeInit(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0044)));  
  DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR;
  ...
  DMA_InitStructure.DMA_Priority = ((uint32_t)0x00003000);
  DMA_InitStructure.DMA_M2M = ((uint32_t)0x00000000);
  DMA_Init(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0044)), &DMA_InitStructure);

   
  DMA_DeInit(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058)));  
  DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR;
  DMA_InitStructure.DMA_MemoryBaseAddr = (uint32_t)RxBuffer;
  DMA_InitStructure.DMA_DIR = ((uint32_t)0x00000000);
  DMA_InitStructure.DMA_BufferSize = 16;
  DMA_Init(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058)), &DMA_InitStructure);	
...
DMA_StructInit(&dma);
dma.DMA_PeripheralBaseAddr = (uint32_t)&(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR);
dma.DMA_MemoryBaseAddr = (uint32_t)&dataBuffer[0];
dma.DMA_DIR = ((uint32_t)0x00000010);
dma.DMA_BufferSize = 8;
dma.DMA_PeripheralInc = ((uint32_t)0x00000000);
dma.DMA_MemoryInc = ((uint32_t)0x00000080);
dma.DMA_PeripheralDataSize = ((uint32_t)0x00000000);
dma.DMA_MemoryDataSize = ((uint32_t)0x00000000);
DMA_Init(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0044)), &dma);	
 
GPIO_StructInit(&port);
port.GPIO_Mode = GPIO_Mode_AF_PP;
port.GPIO_Pin = ((uint16_t)0x0200);
port.GPIO_Speed = GPIO_Speed_50MHz;
GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), &port);
 
port.GPIO_Mode = GPIO_Mode_AF_PP;
port.GPIO_Pin = ((uint16_t)0x0400);
port.GPIO_Speed = GPIO_Speed_50MHz;
GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), &port);
 
USART_StructInit(&usart);
usart.USART_BaudRate = 921600;
USART_Init(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), &usart);



((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058))->CCR = 0; 
((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058))->CPAR = (uint32_t)dt;
((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058))->CMAR = (uint32_t)&((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR; 
((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058))->CNDTR = 16; 

((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0000))->IFCR |= ((uint32_t)0x00020000);
USART_ClearFlag(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0020)|((uint16_t)0x0010));
((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058))->CCR = ((uint16_t)0x0080)|((uint16_t)0x0001); 
