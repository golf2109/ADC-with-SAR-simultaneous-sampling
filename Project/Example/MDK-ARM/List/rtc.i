...
int  RtcInit  (void)
{
  ...
  ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR |= ((uint16_t)0x0100);
	...
	if ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR & ((uint32_t)0x00008000)) != ((uint32_t)0x00008000))
	{
		...
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR |= ((uint32_t)0x00010000);
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR &= ~((uint32_t)0x00010000);
		...
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR |= ((uint32_t)0x00008000) | ((uint32_t)0x00000100);
		...
		((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->PRLH = 0;
		((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->PRLL = 0x8000;         

		((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EVCR =0xAD; 
		
		((BKP_TypeDef *) (((uint32_t)0x40000000) + 0x6C00))->RTCCR |=	((uint16_t)0x0080); 
		
((BKP_TypeDef *) (((uint32_t)0x40000000) + 0x6C00))->RTCCR |=	((uint16_t)0x0200) | ((uint16_t)0x0100);
		
		((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CRL &= ~((uint8_t)0x10);
    
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR |= ((uint32_t)0x00000001);
		while ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR & ((uint32_t)0x00000001)) != ((uint32_t)0x00000001)){}
		...
		((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CRL &= (uint16_t)~((uint8_t)0x08);
		while((((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CRL & ((uint8_t)0x08)) != ((uint8_t)0x08)){}
		return	0;
	}
   return	1;
}
...
((BKP_TypeDef *) (((uint32_t)0x40000000) + 0x6C00))->RTCCR |=	((uint16_t)0x0080); 
	...
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR &= ~(((uint32_t)0x00000001) | ((uint32_t)0x00000004));
    ...
    ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CRL &= ~((uint8_t)0x08);
...
{
	uint32_t t;
	t = ((uint32_t)((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CNTH << 16) | ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CNTL;
	counter_to_struct( t, rtc ); 
	adjustDST( rtc );
}
 ...
 void SetCounterRTC(uint32_t cnt)
{
	...
	((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CRL |= ((uint8_t)0x10);
  ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CNTH = cnt>>16;
	((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CNTL = cnt;
	((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CRL &= ~((uint8_t)0x10); 
}
...
void	RTC_setup_SPL(void)
{
  ...
  PWR_BackupAccessCmd(ENABLE);
    ...
    RCC_APB1PeriphClockCmd(((uint32_t)0x08000000) | ((uint32_t)0x10000000), ENABLE);
