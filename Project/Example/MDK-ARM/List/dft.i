...
int	adc_sample_number=0;	
int	adc_sample_now=0;		
extern	char	adc_ch;
...
#line 3 "..\\..\\..\\dft.c"
extern void Delay_mks(volatile uint32_t nTime);
...
my_arr[0]=buffer[(512-1)&(idxIN-23*8+adc_ch-8)];
my_arr[1]=buffer[(512-1)&(idxIN-22*8+adc_ch-8)];
my_arr[2]=buffer[(512-1)&(idxIN-21*8+adc_ch-8)];
my_arr[3]=buffer[(512-1)&(idxIN-20*8+adc_ch-8)];
my_arr[4]=buffer[(512-1)&(idxIN-19*8+adc_ch-8)];
my_arr[5]=buffer[(512-1)&(idxIN-18*8+adc_ch-8)];
my_arr[6]=buffer[(512-1)&(idxIN-17*8+adc_ch-8)];
my_arr[7]=buffer[(512-1)&(idxIN-16*8+adc_ch-8)];
my_arr[8]=buffer[(512-1)&(idxIN-15*8+adc_ch-8)];
my_arr[9]=buffer[(512-1)&(idxIN-14*8+adc_ch-8)];
my_arr[10]=buffer[(512-1)&(idxIN-13*8+adc_ch-8)];
my_arr[11]=buffer[(512-1)&(idxIN-12*8+adc_ch-8)];
my_arr[12]=buffer[(512-1)&(idxIN-11*8+adc_ch-8)];
my_arr[13]=buffer[(512-1)&(idxIN-10*8+adc_ch-8)];
my_arr[14]=buffer[(512-1)&(idxIN-9*8+adc_ch-8)];
my_arr[15]=buffer[(512-1)&(idxIN-8*8+adc_ch-8)];
my_arr[16]=buffer[(512-1)&(idxIN-7*8+adc_ch-8)];
my_arr[17]=buffer[(512-1)&(idxIN-6*8+adc_ch-8)];
my_arr[18]=buffer[(512-1)&(idxIN-5*8+adc_ch-8)];
my_arr[19]=buffer[(512-1)&(idxIN-4*8+adc_ch-8)];
my_arr[20]=buffer[(512-1)&(idxIN-3*8+adc_ch-8)];
my_arr[21]=buffer[(512-1)&(idxIN-2*8+adc_ch-8)];
my_arr[22]=buffer[(512-1)&(idxIN-1*8+adc_ch-8)];
my_arr[23]=buffer[(512-1)&(idxIN-0*8+adc_ch-8)];
...
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00000002);

	zzz = *(volatile unsigned long *)0xE0001004;
	dft(adc_ch);
	mat_potok_all();
	out_stm();
	input_stm();
	zzz1_m1 = (*(volatile unsigned long *)0xE0001004-zzz);
((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR=((uint32_t)0x00020000);	
