...
u8			StateAI=(0x80|0x01), StateClbAI;
...
#line 5 "..\\..\\..\\main.h"
#line 1 "C:\\Keil_474\\ARM\\ARMCC\\bin\\..\\include\\stdio.h"
...
#line 38 "C:\\Keil_474\\ARM\\ARMCC\\bin\\..\\include\\stdio.h"
...
#line 129 "C:\\Keil_474\\ARM\\ARMCC\\bin\\..\\include\\stdio.h"
...
#line 948 "C:\\Keil_474\\ARM\\ARMCC\\bin\\..\\include\\stdio.h"
...
void Delay_mks(volatile uint32_t nTime);
...
*(volatile unsigned long *)0xE000EDFC |= 0x01000000;
*(volatile unsigned long *)0xE0001000|= 1; 
...
for(adc_sample_number=0; adc_sample_number<24; adc_sample_number++) 
...
adc_sample_number=0;
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH=0x11111111;	
	
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH |= ((uint32_t)0x00000080);
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH &=~((uint32_t)0x00000040);
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH |= ((uint32_t)0x00000030);	
...
ReadFLASH((u16 *)&Calibr, 0x0800FC00, sizeof(Calibr));

WriteFLASH((u16 *)&Calibr, 0x0800FC00, sizeof(Calibr));
...
ReadFLASH((u16 *)&Calibr, 0x0800FC00, sizeof(Calibr));
	...
	if (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CSR & ((uint32_t)0x08000000))
		{
			ReStarts=0;
			
	}
	else if (ReStarts<9999) ++ReStarts;
  ...
  USART_DMACmd(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0040) | ((uint16_t)0x0080), ENABLE);

  
	DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0044)), ENABLE);
  
	DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058)), ENABLE);

  
  USART_Cmd(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ENABLE);

	
	if(Read_from_FRAM(0x0001) == 0xAA55)
	{
		FRAM_init();
	}
	FRAM_setting();
	
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH |= ((uint32_t)0x00000004);
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH &=~((uint32_t)0x00000008);
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH &=~((uint32_t)0x00000003);		
