...
void	write_year(uint32_t	year)
{
	...
	void	writeRTC(void)	
{
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR |= ((uint32_t)0x10000000);  
...
rtc_settime (&timeset);
    ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CRL &= ~((uint8_t)0x10); 
		...
		while( (((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CRL & ((uint8_t)0x20)) == 0 ){} ; 
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR &= ~((uint16_t)0x0100); 
}

void USART1_Send(u8 chr) {
  while(!(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->SR & ((uint16_t)0x0040)));
  ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR = chr;
}
void USART1_Send_String(char* str) {
  int i=0;
  while(str[i])
